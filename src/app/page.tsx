        ...
        <div className="container mx-auto grid lg:grid-cols-2 gap-8 items-center py-12 md:py-24">
          <div className="flex flex-col gap-4 text-center lg:text-left">
            ...
            <div className="flex gap-4 justify-center lg:justify-start mt-4">
              <Button asChild size="lg" className="shadow-glowing-sm">
                <Link href="/ask-a-mentor">Get Started <ArrowRight className="ml-2"/></Link>
              </Button>
            </div>
          </div>
      ...
      <section className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature) => (
            <Card key={feature.title} className="shadow-neumorphic transition-transform hover:scale-105 duration-300 ease-in-out bg-background/70 backdrop-blur-sm border-white/20">
