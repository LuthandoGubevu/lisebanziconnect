...
export default function UpcomingEventsPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <Alert className="shadow-neumorphic-sm bg-accent/10 border-accent/20 text-accent-foreground">
        <Info className="h-4 w-4 text-accent" />
        <AlertTitle className="text-accent font-bold">Admin Notice</AlertTitle>
        <AlertDescription>
